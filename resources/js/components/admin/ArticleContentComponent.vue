        ...
        <div class="btn-group my-2" role="group">
            ...
            <div class="dropdown-menu right-0" aria-labelledby="btnGroupDrop1">
                ...
                <input type="button" @click="addText" data-toggle="modal" data-target="#Modal" class="dropdown-item"
                       value="متن">
                <input type="button" @click="addGallery" data-toggle="modal" data-target="#Modal" class="dropdown-item"
                       value="گالری تصاویر">
        ...
        <div v-for="item in contentlist" :key="item.id">
            <div class="card mt-2">
                <div class="card-header row m-0 px-1">
                    <div class="col-6">
                        <i class="far fa-check-circle fa-lg ml-2" style="color: #5BB760;" title="انتشار" v-if="item.publish == true"></i>
                        <i class="fas fa-ban fa-lg ml-2" style="color: #EB3E37;" title="عدم انتشار" v-else></i>
                        {{item.article_type.type}}
                    </div>
                    <div class="col-6 icons">
                        <i title="ویرایش" style="color: #00B2C9;" @click="editcontent(item.id, item.text, item.publish, item.article_type_id, item.galleries)"
                           data-toggle="modal"
                           data-target="#Modal"
                           class="fas fa-edit ml-2 fa-lg"></i>
                        <i title="حذف" style="color: #EB3E37;" @click="deletecontent(item.id)" class="fas fa-trash ml-3 fa-lg"></i>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-1 mt-3" v-if="actionflag != 'text'">
                            <input type="checkbox" class="form-check-input publish-checkbox mr-2" v-model="publish">
                            <label class="form-check-label pr-2 mt-1 mr-4">نمایش</label>
                        </div>
                    </div>
